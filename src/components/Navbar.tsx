    ...
    <header className="sticky top-0 z-40 bg-[#FAF8F5] border-b-2 sm:border-b-[3px] border-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 sm:gap-4">
          <Link
            href="/"
            className={`px-3 py-1.5 text-xs sm:text-sm font-bold border-2 border-black transition-all ${
              currentPath === '/'
          ...
          <Link
            ...
            className={`px-3.5 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-black border-2 sm:border-[3px] border-black flex items-center gap-1.5 transition-all ${
